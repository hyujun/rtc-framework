...
class CoMTask final : public TaskBase {
 public:
  [[nodiscard]] std::string_view Name() const noexcept override { return "com"; }
  ...
  [[nodiscard]] int ResidualDim() const noexcept override { return 3; }
  ...
  void SetComReference(const Eigen::Vector3d& com_des,
  ...
  void SetGains(const Eigen::Vector3d& kp, const Eigen::Vector3d& kd) noexcept;
