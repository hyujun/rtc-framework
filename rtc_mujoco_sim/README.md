...
# rtc_controller_manager 파라미터 오버라이드 (시뮬 전용 차이값만)
rt_controller:
  ros__parameters:
...
| P | 스크린샷 저장 (`RTC_SESSION_DIR/sim/` → `~/ros2_ws/ur5e_ws/logging_data/` 폴백) |
...
rtc_controller_manager::RegisterRos2ResourceProvider();
```
