...
│       ├── momentum_observer_log_pod.hpp <- 일반화 운동량 관측기 잔차 (#135 Layer 1b) — device order r + ‖r‖∞ + valid/invalid_reason/ticks_since_seed, 단일 momentum_observer.csv (3 데모 컨트롤러 공용)
