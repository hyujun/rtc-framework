...
namespace integrated_bringup::logging {
...
// `[integrated_bringup.demo_joint_controller]` makes both fields explicit. See
...
inline rclcpp::Logger DemoJointLogger() {
  return rclcpp::get_logger("integrated_bringup.demo_joint_controller");
}
...
inline rclcpp::Logger SharedConfigLogger() {
  return rclcpp::get_logger("integrated_bringup.demo_shared_config");
}
