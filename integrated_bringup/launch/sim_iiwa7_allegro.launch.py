"""
sim_iiwa7_allegro.launch.py — MuJoCo simulation launch for iiwa7 + Allegro
=========================================================================

Usage:
  # Default
  ros2 launch integrated_bringup sim_iiwa7_allegro.launch.py
  ...
  # Headless
  ros2 launch integrated_bringup sim_iiwa7_allegro.launch.py enable_viewer:=false
...
def launch_setup(context, *args, **kwargs):
    ...
    # MuJoCo sim params: agnostic defaults (rtc_mujoco_sim) + iiwa7+Allegro
    ...
    sim_config = PathJoinSubstitution(
        [pkg_bringup, "config", "iiwa7_allegro", "mujoco_simulator.yaml"]
    )
    ctrl_config = PathJoinSubstitution([pkg_bringup, "config", "iiwa7_allegro", "sim.yaml"])

    # No hand UDP driver on iiwa7+Allegro — sensor stack disabled.
    hand_config = None
...
def generate_launch_description():
    ...
    initial_controller_arg = DeclareLaunchArgument(
        ...
        description=(
            ...
            "Empty = use value from config/iiwa7_allegro/sim.yaml."
        ),
    )
