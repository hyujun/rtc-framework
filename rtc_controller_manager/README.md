...
| 파라미터 | 타입 | 코드 기본값 | 설명 |
|---------|------|------------|------|
| `robot_namespace` | string | `""` | 매니저 레벨 토픽 네임스페이스 (`/{robot_ns}/...`). 비어 있으면 prefix 없이 publish. 로봇별 bringup이 override (예: `ur5e_bringup` → `"ur5e"`) |
