...
public:
  // Histogram: 0–2 000 us range, 100 us buckets.
  // Bucket kBuckets holds all samples >= 2 000 us (overflow).
  ...
  // Most recent single Compute() duration in us.
  ...
  // Example output:
  //   PDController timing: count=1000  mean=3.2us  min=2.1us  max=18.4us
  //     p95=5.6us  p99=9.2us  over_budget=0 (0.0%)
