...
| 파지 타임아웃 | 힘 임계값이 너무 높거나 센서 미연결 | `threshold_N` 조정, `/<active_ctrl>/p1a/grasp_state` 확인 (hand_group 세그먼트, ur5e_p1a) |
...
ros2 topic echo /<active_ctrl>/p1a/grasp_state   # hand_group 세그먼트 (ur5e_p1a)
