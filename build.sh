...
show_help() {
  ...
  echo "                      rtc_status_monitor, rtc_inference, rtc_scripts, ur5e_description,"
  echo "                      ur5e_hand_driver, ur5e_hand_status_monitor, ur5e_bringup,"
  echo "                      ur5e_bt_coordinator, rtc_tools"
  echo ""
