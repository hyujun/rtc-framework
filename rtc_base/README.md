...
logging_data/YYMMDD_HHMM/
  controller/                -- rtc_controller_manager 의 RT 루프 CSV (state_log, sensor_log, timing_log)
  controllers/<config_key>/  -- 개별 controller LifecycleNode 가 자체 기록하는 CSV
                                (예: demo_wbc_controller/mpc_solve_timing.csv;
                                writer = rtc_mpc/logging/mpc_solve_timing_logger.hpp)
  device/                    -- device 통신 통계
  sim/                       -- mujoco 스크린샷
  plots/                     -- 플롯 출력
  motions/                   -- 모션 에디터 JSON
