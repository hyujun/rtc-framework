...
> **참고:** UR5e custom hand 전용 상수 (`kNumHandMotors`, `kDefaultHandMotorNames`, `kDefaultFingertipNames`)는 `udp_hand_driver/udp_hand_constants.hpp`로 이동되었습니다. `kNumHandJoints`, `kDefaultRobotJointNames`, `RobotState`는 사용처가 없어 삭제되었습니다.
