...
| `/target_joint_positions` | `std_msgs/Float64MultiArray` | 목표값 (컨트롤러별 해석 다름) |
...
| 4 | UrFiveEHandController | position |
...
| `/hand/command` | `std_msgs/Float64MultiArray` | 10개 핸드 모터 명령 (UrFiveEHandController) |
