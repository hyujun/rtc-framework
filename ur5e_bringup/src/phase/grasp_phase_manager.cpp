...
GraspPhaseInitError
GraspPhaseManager::LoadTransition(
  const YAML::Node & cfg,
...
int GraspPhaseManager::EvaluateTransition(
  int current_id,
...
rtc::mpc::PhaseContext GraspPhaseManager::BuildContext(
  int id,
  bool changed) const
{
...
rtc::mpc::PhaseContext GraspPhaseManager::Update(
