...
RTC_REGISTER_CONTROLLER(demo_joint_controller, "", "ur5e_bringup",
                        std::make_unique<ur5e_bringup::DemoJointController>(urdf))

RTC_REGISTER_CONTROLLER(demo_task_controller, "", "ur5e_bringup",
                        std::make_unique<ur5e_bringup::DemoTaskController>(
                            urdf, ur5e_bringup::DemoTaskController::Gains{}))

RTC_REGISTER_CONTROLLER(demo_wbc_controller, "", "ur5e_bringup",
