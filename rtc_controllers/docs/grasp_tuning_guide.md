...
**셋 다 §6.7–6.8 이 종결했다.** 1 은 σ 실측, 2 는 강체에서 진동 부재, 3 은 `k_est` 가 pin 을 안
벗어나고(#424 AC 충족) 풀어도 물체 강성으로 수렴하지 않음. 다음 계측은 이 runbook 을 **#426 의
결정(제거 또는 재설계) 이후**에 회귀 검증으로 쓰는 것이지, 같은 질문을 다시 재는 것이 아니다.
