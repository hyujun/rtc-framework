...
- YAML: [demo_shared.yaml](../../integrated_bringup/config/ur5e_p1a/controllers/demo_shared.yaml) (`force_pi_grasp:` 블록)
...
기본값은 [grasp_types.hpp](../include/rtc_controllers/grasp/grasp_types.hpp) 와 [demo_shared.yaml](../../integrated_bringup/config/ur5e_p1a/controllers/demo_shared.yaml) 의 `force_pi_grasp:` 블록 기준.
...
1. [demo_shared.yaml](../../integrated_bringup/config/ur5e_p1a/controllers/demo_shared.yaml) 의 `force_pi_grasp:` 블록을 편집
