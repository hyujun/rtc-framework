...
class TaskAdmittanceController final : public RTControllerInterface {
 public:
  ...
  /// see params/task_admittance_params.hpp for why (#236 S7c-2, D-B/G2). The
  /// alias keeps every existing spelling (`TaskAdmittanceController::Gains`)
  /// resolving to the lifted definition.
  using Gains = params::TaskAdmittanceParams;
