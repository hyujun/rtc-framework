...
void OperationalSpaceController::UpdateGainsFromMsg(
    std::span<const double> gains) noexcept {
  // layout: [kp_pos×3, kd_pos×3, kp_rot×3, kd_rot×3, damping,
  // enable_gravity(0/1),
...
std::vector<double>
OperationalSpaceController::GetCurrentGains() const noexcept {
  // layout: [kp_pos×3, kd_pos×3, kp_rot×3, kd_rot×3, damping,
  // enable_gravity(0/1),
  //          trajectory_speed, trajectory_angular_speed,
  //          max_traj_velocity, max_traj_angular_velocity] = 18
