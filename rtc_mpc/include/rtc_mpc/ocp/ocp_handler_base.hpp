...
/// OCP assembly (Aligator-backed `KinoDynamicsOCP`, `FullDynamicsOCP`). It
...
///        specific dynamics class (e.g. KinoDynamicsOCP, FullDynamicsOCP).
...
public:
  ...
  /// @return dispatch key string literal (`"kinodynamics"`, `"fulldynamics"`).
