#ifndef UR5E_RT_BASE_UDP_CODEC_HPP_
#define UR5E_RT_BASE_UDP_CODEC_HPP_

// Generic UDP packet codec concept and helpers.
//
// Defines the UdpPacketCodec concept: any type that provides:
...
//   - static Decode(span<const char>, State&) -> bool
//   - static Encode(const SendPacket&, span<uint8_t>) -> void
//
// Domain-specific codecs (hand_packets.hpp) satisfy this concept.
...
template <typename C>
concept UdpPacketCodec = requires {
...
[[nodiscard]] inline bool DecodePacket(
    std::span<const char> buf, T& out) noexcept {
...
#endif  // UR5E_RT_BASE_UDP_CODEC_HPP_
