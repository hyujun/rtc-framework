...
from rtc_tools.launch.trace_action import RTC_UST_EVENTS, _with_rtc_events, make_trace_action
...
def test_empty_kernel_arg_yields_empty_event_list(recording_trace, tmp_path):
    """`trace_events_kernel:=` (empty) must reach Trace as [] — the UST-only path.
