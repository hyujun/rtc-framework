...
| S5 포구 컨트롤러 골격·입력·추종 | **S5.1·S5.2·S5.2e 완료** (2026-09-22, 브랜치 `feat/s5-catching-controller`) — S5.3~S5.5 진행 중 | S5.2e: D-24 (a) 센서 lane (PROC-3 전체 5518/0). S5.1: P-1 (a)~(d) · 무장 latch `catching.enable` · A-S5-1 실기 park · TSAN clean (positive control 로 검출 확인). S5.2: 이름 기반 PointCloud2 파서 + SeqLock + D-2 + A-S5-4 되감김 정책, G1-A~C·E·F·H·I·J green, ASan/UBSan clean (경계 제거 사본에서 stack-buffer-overflow 검출). 남은 게이트: G4-H·G5-*·G7-H (d)·G8-H·§13 (S5.3~S5.5) |
| S6 계획기 스레드 | 대기 | — |
| S7 손 시퀀서·슈퍼바이저 | 대기 | — |
| S8 sim 통합 평가 | 대기 | — |
