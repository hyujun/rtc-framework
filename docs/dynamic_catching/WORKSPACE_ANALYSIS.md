...
| W5-6 | 발행 주기, $N$(width)의 범위, 지평 길이, 지연 분포 | TBD-VIS-04 | 예시 sim profile: 지평 0.5 s, 간격 0.05 s, 최대 10 점, 발행 ≤ 30 Hz (ball_perception 설정 (2026-09-19)) — S0.7 결과로 목표를 지평 0.8 s·**16 점**으로 올렸다 (plan D-15; 점 수는 2026-09-20 정정 — 예측점이 `step, 2·step, …, horizon` 이라 t = 0 이 없어 0.8/0.05 = 16 이다). 단 **요구 사양은 포구 제어기가 정하고 sim profile 을 맞춘다 (D-15, S3.6)**. 실측 주기·N·지연 분포는 S3.4 |
