...
[[nodiscard]] sensor_msgs::msg::PointCloud2 BuildPointCloud2(
    const std::vector<PointWithNormal>& points, const builtin_interfaces::msg::Time& stamp,
    const std::string& frame_id = "base_link");
...
[[nodiscard]] visualization_msgs::msg::MarkerArray BuildProtuberanceMarkers(
    ...
    const builtin_interfaces::msg::Time& stamp, const std::string& frame_id = "base_link");
