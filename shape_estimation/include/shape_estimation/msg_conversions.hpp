...
[[nodiscard]] ToFSnapshot ConvertFromMsg(const rtc_msgs::msg::ToFSnapshot& msg);

/// 내부 ShapeEstimate → ROS msg 변환
[[nodiscard]] shape_estimation_msgs::msg::ShapeEstimate ToMsg(const ShapeEstimate& estimate,
...
[[nodiscard]] shape_estimation_msgs::msg::ShapeEstimate ToMsg(
    const ShapeEstimate& estimate, const ToFSnapshot& snapshot,
    const ProtuberanceResult& protuberance, const std_msgs::msg::Header& header);
